...
export const ReviewListPage = () => {
    ...
    useEffect(() => {
        const fetchBookReviewsData = async () => {
            ...
            setTotalAmountOfReviews(responseJsonReviews.pagination.totalRecords);
            setTotalPages(responseJsonReviews.pagination.totalRecords);
    ...
    return (
        <div className="container mt-5">
            ...
            {totalPages > 1 && <Pagination currentPage={currentPage} totalPages={totalPages-1} paginate={paginate} />}
        </div>
    );
}
